...
<?php
    ...
    // Variables
    // En php, on ne déclare pas le type (entier, chaîne) de variable
    ...
    $utilisateur = null; // null, idéale comme valeur temporaire

    // Concaténation
    echo  "<p>Résultat : ".$resultat."</p>";
    echo "<p>" . $nb1 . " * " . $nb2 . " = <b>" . $resultat . "</b></p>";
    ...
    echo "</br>".$joueurs[0]; // renvoie Bonucci
