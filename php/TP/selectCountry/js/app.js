//console.log('ok');
var pays_infos = []; // tableau (vide au départ) permettant de mettre en cache le retour des requêtes Ajax
...
$('select').on('change',function(){
    ...
    if (option > 0) {
        ...
        // sinon index_pays vaudra l'indie du pays trouvé dans le tableau
